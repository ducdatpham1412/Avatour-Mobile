...
//     if (this.preNumberComments !== this.props.bubbleFocusing.totalComments) {
//       if (this.setList) {
//         this.setList((preValue: Array<TypeBubblePalace | TypeGroupBuying>) => {
...
//             return {
//               ...item,
//               totalComments: this.props.bubbleFocusing.totalComments,
//             };
//           });
//         });
//       }
...
//                 },
//               ]}
//               onPress={() => this.tabViewRef.current?.navigateToIndex(0)}
//             />
//             <StyleText
...
//                 },
//               ]}
//               onPress={() => this.tabViewRef.current?.navigateToIndex(1)}
//             />
//             <StyleTouchable
...
//                 inputCommentContainerStyle={inputCommentContainerStyle}
