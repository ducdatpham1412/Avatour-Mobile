...
const discovery = {
  ...
  durationHere: 'Thời gian trải nghiệm',
  free: 'Miễn phí',
  paid: 'Có phí',
...
const tour = {
  ...
  switchToPrivateMode: 'Chuyển về chế độ riêng tư',
  afterToPrivate:
    'Sau khi chuyển về chế độ riêng tư, mọi người sẽ không thể tìm kiếm và xem thông tin lịch trình này trên trang cá nhân của bạn nữa',
...
const profile = {
  ...
  goToCheckIn: 'Đi tới check-in',
  toSaveTheBestMoments:
    'để lưu giữ những khoảnh khắc cho chuyến đi của bạn nhé',
