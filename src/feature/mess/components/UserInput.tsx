...
//       const temptFocus = effectWhenHaveText ? isFocusing : isFocusing || text;
...
//           const finalImages = [allImages[index - 1], allImages[index]];
...
//             <StyleTouchable onPress={onChooseImageFromCamera} hitSlop={hitSlop}>
//               <MaterialCommunityIcons
//                 name="camera-outline"
//                 style={[styles.iconTool, {color: theme.borderColor}]}
//               />
//             </StyleTouchable>
//           </View>
//         )}
