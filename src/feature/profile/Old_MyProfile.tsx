...
const ProfileEnjoy = () => {
  ...
  return (
    <>
      ...
      <StyleActionSheet ref={optionRef} listTextAndAction={modalizeMyProfile} />
    </>
  );
};
...
const ProfileAccount = () => {
  ...
  const isInTabProfile = useRef(route.name === PROFILE_ROUTE.myProfile).current;
  ...
  const listCheckTabLazy = useRef<Array<boolean>>([true, false, false, false]);
    ...
    <>
      ...
      <View style={{flex: 1, backgroundColor: theme.backgroundColor}}>
          ...
          <StyleTabView
            ...
            <View
              style={[
                ...
                {
                  justifyContent: isShopAccount ? 'space-between' : 'center',
                  flexDirection: 'row',
                  flexWrap: 'wrap',
                },
              ]}>
              ...
              {myGbPaging.loading && (
                <LoadingIndicator color={theme.textHightLight} />
              )}
            </View>
            ...
            <View
              ...
              {postsLikedPaging.list.map(item =>
                RenderItemGbFavoriteJoined(item, postsLikedPaging.setList),
              )}
            ...
            <View
              ...
              <View style={{width: '100%'}}>
                <StyleText
                  ...
                  customStyle={[styles.textJoining, {color: theme.borderColor}]}
                />
                <StyleList
                  onTouchStart={() => tabViewRef.current?.disableTouchable()}
                  onTouchEnd={() => tabViewRef.current?.enableTouchable()}
                  horizontal
                  data={gbJoiningPaging.list}
                  renderItem={({item}) =>
                    RenderItemGbJoining(item, gbJoiningPaging.setList)
                  }
              ...
              />
              {gbJoinedPaging.list.map(item => RenderItemGbJoined(item))}
            ...
            {isShopAccount && (
              <View
                ...
                {postReviewPaging.list.map(item => RenderItemReview(item))}
        ...
        <StyleActionSheet
          ref={optionRef}
          listTextAndAction={
            isShopAccount ? modalizeMyProfileShop : modalizeMyProfile
          }
        />
