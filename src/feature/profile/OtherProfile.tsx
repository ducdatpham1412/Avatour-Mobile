...
import {apiBlockUser} from 'api/setting';
...
interface Props {
  route: {
    params: AppParamsList[ROOT_SCREEN.otherProfile];
  };
}
  ...
  if (isBlock) {
    return (
      <>
        ...
        <View
          style={[styles.overlayView, {backgroundColor: theme.backgroundColor}]}
        />
        <ViewSafeTopPadding />
        <SearchAndSetting
          ...
          <StyleTouchable
            ...
            <StyleText
              ...
              customStyle={[
                styles.textInteract,
                {
                  color: isFollowing ? theme.textColor : theme.highlightColor,
                  fontWeight: 'bold',
                },
              ]}
            />
    ...
    return (
      <View
        ...
        <Animated.View
          ...
          <View
            style={[styles.indicatorIn, {borderTopColor: theme.borderColor}]}
          />
        </Animated.View>
      </View>
    );
        ...
        <ScrollView
          ...
          <StyleTabView
            ...
            onFirstNavigateToIndex={index => {
              if ((index === 1 && isShopAccount) || seeReviewFirst) {
            ...
            <View style={styles.tabView}>
              {listPostsPaging.list.map(item => RenderItemMyGb(item))}
            ...
            <View style={styles.tabReview}>
              {isShopAccount &&
                listPostsReviewAbout.list.map(item => RenderItemReview(item))}
