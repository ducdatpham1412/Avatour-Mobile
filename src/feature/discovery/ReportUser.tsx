...
const ReportUser = ({route}: Props) => {
  ...
  return (
    <>
      ...
      <StyleHeader
        title={
          nameUser ? 'discovery.report.reportPerson' : 'discovery.report.title'
        }
        titleParams={{
          name: nameUser,
        }}
      ...
      <StyleContainer customStyle={styles.body} scrollEnabled>
        ...
        <StyleText
          ...
          customStyle={[styles.titleChooseReason, {color: theme.textColor}]}
        />
        <View style={styles.chooseReasonView}>
          <View
            style={[styles.textReasonBox, {borderColor: theme.borderColor}]}>
            <StyleText
              i18Text={reasonReport?.name || 'common.null'}
              customStyle={[styles.textReason, {color: theme.textColor}]}
              numberOfLines={1}
            />
          </View>
          <StyleTouchable
            ...
            <FontAwesome5
              name="chevron-down"
              style={[styles.iconPickerDown, {color: theme.textColor}]}
            />
          </StyleTouchable>
        </View>
