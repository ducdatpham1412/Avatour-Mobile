...
interface Props {
  route: {
    params: AppParamsList[ROOT_SCREEN.interactBubble];
  };
}
...
const InteractBubble = ({route}: Props) => {
  ...
  const RenderNameAndAvatar = () => {
    return (
      <View
        ...
        <StyleText
          originValue={name}
          customStyle={[styles.nameText, {color: theme.textHightLight}]}
          numberOfLines={1}
        />
      </View>
    );
  ...
  return (
    <View style={[styles.container]}>
      ...
      <Animated.View
        style={[styles.animatedView, {transform: [{rotateY}, {translateY}]}]}>
        <Text style={styles.spaceView} onPress={onTouchBackground} />
        <View
          style={[
            styles.cordBox,
        ...
        <View
          ...
          <View style={styles.inputAndSendView}>
            <StyleInput
              ...
              inputStyle={[styles.input, {color: theme.textHightLight}]}
              multiline
              ...
              isEffectTabBar
            />
            <StyleTouchable onPress={onSendInteract} disable={!message}>
              {RenderIconSend}
            </StyleTouchable>
          </View>
        </View>
