      ...
      <View style={styles.headerView}>
            ...
            <StyleText
              ...
              {item.topic.map(topic => (
                <StyleText
                  key={topic}
                  originValue="・"
                  customStyle={[styles.textTopic, {color: theme.borderColor}]}
        ...
        {item.content ? (
          <StyleText
            ...
            customStyle={[styles.textCaption, {color: theme.textHightLight}]}
            numberOfLines={1}
            onPress={() => onGoToDetailPost(item)}
          />
        ) : (
        ...
        <View style={styles.footerViewDraft}>
          ...
          <StyleTouchable
            ...
            <StyleText
              ...
              customStyle={[styles.textGoToPost, {color: theme.textHightLight}]}
            />
          </StyleTouchable>
        </View>
      );
    ...
    return (
      <View style={styles.footerView}>
        {isLiked ? (
          ...
          <IconNotLiked
            customStyle={[styles.iconLike, {color: theme.borderColor}]}
            onPress={() => {
              onHandleLike({
                isModeExp,
                isLiked,
        ...
        <StyleTouchable
          ...
          <StyleText
            ...
            customStyle={[styles.textLike, {color: theme.borderColor}]}
          />
        </StyleTouchable>
        ...
        <View style={styles.leftBottom}>
          <View
            ...
            <StyleText
              ...
              customStyle={[styles.textStars, {color: theme.borderColor}]}
            />
          </View>
        </View>
      </View>
