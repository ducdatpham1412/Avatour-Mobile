    ...
    return (
      <View style={styles.nameAndContentTouch}>
        ...
        <StyleText
          ...
          customStyle={[styles.contentText, {color: theme.textHightLight}]}
        />
        <View style={styles.replyBox}>
          <StyleTouchable
            onPress={() => onPressReply?.(item.id, item.creatorName)}
            hitSlop={10}
            customStyle={styles.replyTouch}>
            <StyleText
              i18Text="common.reply"
              customStyle={[styles.replyText, {color: theme.borderColor}]}
            />
          </StyleTouchable>
        </View>
      </View>
