...
import {apiGetDetailBubble} from 'api/discovery';
      ...
      <View style={styles.headerView}>
        <View style={styles.avatarNameOptionBox}>
          ...
          <View style={styles.nameTime}>
            <StyleText
              ...
              customStyle={[styles.textName, {color: theme.textHightLight}]}
            />
            {bubble?.created && (
              <StyleText
                originValue={formatFromNow(bubble?.created)}
                customStyle={[styles.textCreated, {color: theme.borderColor}]}
              />
            )}
          </View>
          ...
          {typeof bubble?.topic === 'number' && (
            <StyleText
              originValue="   ・ "
              customStyle={[styles.textTopic, {color: theme.textColor}]}>
              <StyleText
        ...
        {bubble?.location && (
          <View style={styles.locationBox}>
            ...
            <StyleText
              ...
              customStyle={[styles.textLocation, {color: theme.highlightColor}]}
            />
          </View>
        )}
        ...
        {bubble?.content ? (
          <StyleMoreText
            ...
            textStyle={[styles.textCaption, {color: theme.textColor}]}
          ...
          <StyleTouchable
            ...
            <View
              ...
              <StyleText
                ...
                customStyle={[styles.textSeeNow, {color: theme.textColor}]}
              />
            </View>
          </StyleTouchable>
        );
        ...
        return (
          <StyleTouchable
            ...
            <View
              ...
              <AntDesign
                name="link"
                style={[styles.iconHouse, {color: theme.textColor}]}
              />
              <StyleText
    ...
    return (
      <View style={styles.footerView}>
        ...
        <View style={styles.likeCommentShareSave}>
          {bubble?.isLiked ? (
            <IconLiked
              customStyle={[styles.iconLike, {color: theme.likeHeart}]}
              onPress={onHandleLike}
            />
          ) : (
            <IconNotLiked
              customStyle={[styles.iconLike, {color: theme.textHightLight}]}
              onPress={onHandleLike}
            />
          )}
          ...
          <StyleTouchable customStyle={styles.iconSave} onPress={onHandleSave}>
            {bubble?.isSaved ? (
              <FontAwesome
                name="bookmark"
                style={[styles.save, {color: Theme.common.gradientTabBar1}]}
              />
            ) : (
              <FontAwesome
                name="bookmark-o"
                style={[styles.save, {color: theme.textHightLight}]}
              />
            )}
          </StyleTouchable>
        </View>
        ...
        <StyleTouchable
          ...
          <StyleText
            i18Text={
              bubble?.totalLikes ? 'discovery.numberLike' : 'discovery.like'
            }
            i18Params={{
              value: bubble?.totalLikes || '',
            }}
            customStyle={[styles.textLike, {color: theme.textColor}]}
          />
        </StyleTouchable>
        ...
        <StyleTouchable
          ...
          <StyleText
            ...
            customStyle={[styles.textComment, {color: theme.borderColor}]}
          />
        </StyleTouchable>
      </View>
    );
