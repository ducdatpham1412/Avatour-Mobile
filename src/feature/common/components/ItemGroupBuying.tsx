  ...
  if (item.status === GROUP_BUYING_STATUS.bought) {
    return (
      <LinearGradient
        ...
        colors={[Theme.common.commentGreen, Theme.common.gradientTabBar2]}>
        <Entypo name="check" style={styles.iconBought} />
        <StyleText i18Text="discovery.bought" customStyle={styles.textBought} />
      </LinearGradient>
    );
  }
  if (
    ...
    return (
      <View
        ...
        <StyleText
          i18Text={isJoined ? 'discovery.joined' : 'discovery.joinNow'}
          customStyle={[
            styles.textTellJoin,
            {
              color: isJoined ? theme.backgroundColor : theme.textHightLight,
            },
          ]}
        />
      </View>
    ...
    return (
      <>
        <View style={styles.locationVerticalBox}>
          <Entypo name="location-pin" style={styles.iconLocationVertical} />
          <StyleText
            originValue={item.creatorLocation}
            customStyle={[styles.textInfo, {color: theme.textHightLight}]}
            numberOfLines={1}
          />
        </View>
      </>
    ...
    <StyleTouchable
      ...
      {!!item.content && isHorizontal && (
        <StyleText
          ...
          customStyle={[styles.textContent, {color: theme.textHightLight}]}
          numberOfLines={1}
        />
      )}
      ...
      <View style={styles.contentView}>
        <View style={{flex: 1}}>
          <View style={styles.infoView}>
            <StyleIcon source={Images.icons.dollar} size={iconSize} />
            <StyleText
              originValue={`${lastPrice.number_people}`}
              customStyle={[styles.textInfo, {color: theme.borderColor}]}
            />
            <StyleText
              originValue=" - "
              customStyle={[styles.textInfo, {color: theme.borderColor}]}
            />
            <StyleText
              originValue={`${formatLocaleNumber(lastPrice.value)}vnd`}
              customStyle={[styles.textInfo, {color: theme.highlightColor}]}
            />
          </View>
        </View>
